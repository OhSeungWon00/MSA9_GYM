...
1. <span style="color:#FF5733;">1️⃣</span> **주제선정 및 기획 의도 선정**  
2. <span style="color:#33A1FF;">2️⃣</span> **요구사항, 기능 정의서 작성, 피그마 화면 설계**  
3. <span style="color:#33FF57;">3️⃣</span> **ERD 설계 DB, 프로젝트 구조 구축**  
4. <span style="color:#FF33F6;">4️⃣</span> **개발 및 테스트**  
5. <span style="color:#FFD700;">5️⃣</span> **수정 및 확정, 결과보고서 작성**
